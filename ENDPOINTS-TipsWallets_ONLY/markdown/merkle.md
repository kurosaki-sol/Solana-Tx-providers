# Merkle QuickSlot (now Blink Labs)

**Auth:** unknown — url_path (SVM RPC) or header (API)
**Min tip:** 0.001 SOL
...
- `7czf8vVLjGUaLqn9DBneEz1sNwP3gLx8Usrq3zMctify`

## Endpoints
- **solana_rpc_blinklabs.url**: `https://sol.blinklabs.xyz/v1/<API_KEY>`
- **quickslot.url**: `https://quicksol.merkle.io`
- **svm_rpc.url**: `https://svm.merkle.io/<api_key>`
- **solana_tx_status.url**: `https://svm.merkle.io/transaction/<hash>`
- **mempool_api.url**: `https://mempool.merkle.io/transactions`
- **api_base.url**: `https://api.merkle.io`
