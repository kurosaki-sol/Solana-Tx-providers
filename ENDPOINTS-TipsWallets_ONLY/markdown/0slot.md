...
**Auth:** required — query string: ?api-key=YOUR_TOKEN
**Min tip:** 0.0001 SOL
...
## Endpoints
- **new_york.https**: `https://ny.0slot.trade`
- **new_york.http**: `http://ny.0slot.trade`
- **frankfurt.https**: `https://de.0slot.trade`
- **frankfurt.http**: `http://de.0slot.trade`
- **amsterdam.https**: `https://ams.0slot.trade`
- **amsterdam.http**: `http://ams.0slot.trade`
- **tokyo.https**: `https://jp.0slot.trade`
- **tokyo.http**: `http://jp.0slot.trade`
- **los_angeles.https**: `https://la.0slot.trade`
- **los_angeles.http**: `http://la.0slot.trade`
- **health_check**: `http://de.0slot.trade/health`
